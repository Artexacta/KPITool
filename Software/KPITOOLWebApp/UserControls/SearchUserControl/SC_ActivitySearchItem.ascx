<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SC_ActivitySearchItem.ascx.cs"
    Inherits="UserControls_SearchUserControl_SC_ActivitySearchItem" %>

<%@ Register Src="../FRTWB/SearchDataControl.ascx" TagName="SearchDataControl" TagPrefix="uc1" %>
...
<div id="CSearch_Item_Container">
    ...
    <div id="CSearch_Item_Panel">
        ...
        <div id="CSearch_Item_Control">
            ...
            <uc1:SearchDataControl ID="SearchDataControl" runat="server" />

<%@ Page Title="<%$ Resources:ShareData, PageTitleProject %>" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ShareProject.aspx.cs" Inherits="Project_ShareProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" Runat="Server">
    <div class="row">
        ...
        <div class="col-md-11">
            <h1 class="text-center">
                <asp:Literal ID="TitleLabel" runat="server" Text="<%$ Resources:ShareData, PageTitleProject %>" />
            </h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <asp:Literal ID="SubtitleLabel" runat="server" Text="<%$ Resources:ShareData, SubtitleLabelProject %>" />
                    <asp:Literal ID="ProjectNameLiteral" runat="server" />
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="tile">
            <div class="t-header">
                <div class="th-title"><asp:Literal ID="UserPermissionsProjectLabel" runat="server" Text="<%$ Resources:ShareData, UserPermissionsProjectLabel %>" /></div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="PermissionsGridView" runat="server" Width="100%" GridLines="None" DataSourceID="PermissionsObjectDataSource"  
                                ...
                                <EmptyDataTemplate>
                                    <p class="text-center">
                                        <asp:Literal ID="NoDataRows" runat="server" Text="<%$ Resources:ShareData, NoDataRowsProject %>" />
                                    </p>
                                </EmptyDataTemplate>
                            </asp:GridView>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <asp:HyperLink ID="ReturnLink" runat="server" NavigateUrl="~/Project/ProjectList.aspx" Text="<%$ Resources:ShareData, ReturnProjectLink %>" CssClass="btn btn-info">
                </asp:HyperLink>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
            ...
            if (!$("#<%= EveryoneCheckBox.ClientID%>").is(':checked')) {
                ...
                if (value == null || value == "") {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ShareProject.aspx/VerifiyActualUser",
                        data: param,
                        dataType: "json",
                        async: false,
        ...
        function VerifiyData() {
            if (Page_ClientValidate("InviteUser") == true) {
                ...
                var param = JSON.stringify({ 'projectId': $("#<%= ProjectIdHiddenField.ClientID %>").val(), 'userId': $("#<%= UserInvitedIdHiddenField.ClientID %>").val() });
                var data;
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ShareProject.aspx/VerifiyUser",
                    data: param,
                    dataType: "json",
                    async: false,
                    success: function (msg) {
    ...
    <asp:ObjectDataSource ID="PermissionsObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ProjectIdHiddenField" PropertyName="Value" Name="objectId" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ObjectActionObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        TypeName="Artexacta.App.ObjectAction.BLL.ObjectActionBLL" SelectMethod="GetObjectActionsForProject"
        OnSelected="ObjectDataSource_Selected">
        <SelectParameters>

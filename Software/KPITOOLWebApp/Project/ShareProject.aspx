<%@ Page Title="Share Project" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" Runat="Server">
    <div class="row">
        ...
        <div class="col-md-11">
            <h1 class="text-center">
                <asp:Literal ID="TitleLabel" runat="server" Text="Share Project" />
            </h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <asp:Literal ID="SubtitleLabel" runat="server" Text="You are sharing a Project: " />
    ...
    <div class="container">
        <div class="tile">
            <div class="t-header">
                <div class="th-title">Users with permissions for this project:</div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="PermissionsGridView" runat="server" Width="100%" GridLines="None" DataSourceID="PermissionsObjectDataSource"  
                                ...
                                <EmptyDataTemplate>
                                    <p class="text-center">
                                        There are no users with permissions for this Project
                                    </p>
                                </EmptyDataTemplate>
                            </asp:GridView>
                        </div>

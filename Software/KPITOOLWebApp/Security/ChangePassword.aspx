                                ...
                                <ChangePasswordTemplate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="validation">
                                            ...
                                            <asp:RegularExpressionValidator ID="PasswordRegularExpressionValidator" runat="server" Display="Dynamic" ControlToValidate="NewPassword" 
                                                ErrorMessage="<%$ Resources:UserData, PasswordRegularExpressionValidator %>" ValidationGroup="ChangePassword" 
                                                ValidationExpression="<%$ Resources: Validations, PasswordFormat %>" />
                                        </div>
                                    </div>
                                    <div class="form-group">

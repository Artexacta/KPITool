...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="Server">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <asp:DropDownList ID="KPITypeCombobox" runat="server" CssClass="form-control m-b-10" DataSourceID="KPITypeObjectDataSource"
                            DataTextField="TypeName" DataValueField="KpiTypeID">
                        </asp:DropDownList>
                        ...
                        <asp:DropDownList ID="UnitCombobox" runat="server" CssClass="form-control m-b-10" Enabled="False"
                            DataSourceID="UnitObjectDataSource" DataTextField="Name" DataValueField="ReportingUnitID">
                        </asp:DropDownList>
                        <asp:ObjectDataSource ID="UnitObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="GetReportingUnit" TypeName="Artexacta.App.ReportingUnit.BLL.ReportingUnitBLL" OnSelected="UnitObjectDataSource_Selected">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="LanguageHiddenField" Name="language" PropertyName="Value" Type="String" />
                            </SelectParameters>
                        </asp:ObjectDataSource>
                        ...
                        <div id="CurrencyPanel" runat="server" style="display: none">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <asp:DropDownList runat="server" ID="MeasuredInCombobox" CssClass="form-control m-b-10" DataSourceID="MeasuredObjectDataSource" DataTextField="Name" DataValueField="CurrencyID">
                                    </asp:DropDownList>
                        ...
                        <asp:DropDownList ID="DirectionCombobox" runat="server" CssClass="form-control m-b-10" DataSourceID="DirectionObjectDataSource" DataTextField="Name" DataValueField="DirectionID">
                        </asp:DropDownList>
                        ...
                        <asp:DropDownList ID="StrategyCombobox" runat="server" CssClass="form-control m-b-10" DataSourceID="StrategyObjectDataSource"
                            DataTextField="Name" DataValueField="StrategyID">
                        </asp:DropDownList>
                        ...
                        <asp:DropDownList ID="ReportingPeriodCombobox" runat="server" CssClass="form-control m-b-10" DataSourceID="PeriodObjectDataSource"
                            DataTextField="Name" DataValueField="ReportingUnitID">
                        </asp:DropDownList>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="TargetPeriodTextBox"
                                        Display="Dynamic"
                                        ValidationGroup="AddData"
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:CustomValidator runat="server" Display="Dynamic" ValidationGroup="AddData"
                                    ErrorMessage="You must select a reporting unit measurement" ClientValidationFunction="validateReportingUnits">
                                </asp:CustomValidator>
                            </div>
                        </div>

                        <%--Starting Date--%>
                        <label>Starting Date<span class="label label-danger">Required</span></label>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <%--Single Target--%>
                        <div id="SingleTargetPanel" runat="server" class="m-b-10  hidden" style="display: block">
                        ...
                        <%--Multiple Targets--%>
                        <div id="MultipleTargetPanel" runat="server" class="m-b-10  hidden" style="display: none">
    ...
    <script type="text/javascript">
        ...
        function LoadMeasured() {
            var currency = $('#CurrencyCombobox').get_value;
            $('#<%=ReportingPeriodHiddenfield.ClientID%>').val(currency);
        }
        ...
        function updateFormByKpiType() {
            ...
            if (vals[3] != "USER_DEFINED") {
                ...
                $('#<%=SelectedStrategyHiddenFields.ClientID%>').val(vals[3]);
            }
            switch (vals[2]) {
                case "USER_DEFINED":
        ...
        function validateTarget(source, arguments) {
            ...
            switch (selectedUnit) {
                case "PERCENTAGE":
                    if ($('#<%=TargetPeriodTextBox.ClientID%>').val() != "") {
                        arguments.IsValid = true;
                    } else {
                        arguments.IsValid = false;
                    ...
                    break;
                case "TIMESPAN":
                    var years = parseInt($('#<%=YearsSingleCombobox.ClientID%>').val());
                    var months = parseInt($('#<%=MonthsSingleCombobox.ClientID%>').val());
                    var days = parseInt($('#<%=DaysSingleCombobox.ClientID%>').val());
                    var hours = parseInt($('#<%=HoursSingleCombobox.ClientID%>').val());
                    var minutes = parseInt($('#<%=MinutesSingleCombobox.ClientID%>').val());

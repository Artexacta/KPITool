<%@ Page Title="<%$ Resources:ShareData, PageTitleKpi %>" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" Runat="Server">
    <div class="row">
        ...
        <div class="col-md-11">
            <h1 class="text-center">
                <asp:Literal ID="TitleLabel" runat="server" Text="<%$ Resources:ShareData, PageTitleKpi %>" />
            </h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <asp:Literal ID="SubtitleLabel" runat="server" Text="<%$ Resources:ShareData, SubtitleLabelKpi %>" />
    ...
    <div class="container">
        <div class="tile">
            <div class="t-header">
                <div class="th-title"><asp:Literal ID="UserPermissionsKpiLabel" runat="server" Text="<%$ Resources:ShareData, UserPermissionsKpiLabel %>" /></div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="PermissionsGridView" runat="server" Width="100%" GridLines="None" DataSourceID="PermissionsObjectDataSource"  
                                ...
                                <EmptyDataTemplate>
                                    <p class="text-center">
                                        <asp:Literal ID="NoDataRows" runat="server" Text="<%$ Resources:ShareData, NoDataRowsKpi %>" />
                                    </p>
                                </EmptyDataTemplate>
                            </asp:GridView>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <asp:HyperLink ID="ReturnLink" runat="server" NavigateUrl="~/Kpi/KpiList.aspx" Text="<%$ Resources:ShareData, ReturnKpiLink %>" CssClass="btn btn-info">
                </asp:HyperLink>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <div class="middle-box">
                    <div class="form-group">
                        ...
                        <asp:CheckBox ID="EveryoneCheckBox" runat="server" Text="<%$ Resources:ShareData, EveryoneCheckBoxKpi %>" style="margin-left: 15px; " />
            ...
            if (!$("#<%= EveryoneCheckBox.ClientID%>").is(':checked')) {
                ...
                if (value == null || value == "") {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ShareKpi.aspx/VerifiyActualUser",
                        data: param,
                        dataType: "json",
                        async: false,

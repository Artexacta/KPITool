<%@ Page Title="<%$ Resources:ShareData, PageTitleActivity %>" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ShareActivity.aspx.cs" Inherits="Activity_ShareActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" Runat="Server">
    <div class="row">
        ...
        <div class="col-md-11">
            <h1 class="text-center">
                <asp:Literal ID="TitleLabel" runat="server" Text="<%$ Resources:ShareData, PageTitleActivity %>" />
            </h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <asp:Literal ID="SubtitleLabel" runat="server" Text="<%$ Resources:ShareData, SubtitleLabelActivity %>" />
                    <asp:Literal ID="ActivityNameLiteral" runat="server" />
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="tile">
            <div class="t-header">
                <div class="th-title"><asp:Literal ID="UserPermissionsActivityLabel" runat="server" Text="<%$ Resources:ShareData, UserPermissionsActivityLabel %>" /></div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="PermissionsGridView" runat="server" Width="100%" GridLines="None" DataSourceID="PermissionsObjectDataSource"  
                                ...
                                <EmptyDataTemplate>
                                    <p class="text-center">
                                        <asp:Literal ID="NoDataRows" runat="server" Text="<%$ Resources:ShareData, NoDataRowsActivity %>" />
                                    </p>
                                </EmptyDataTemplate>
                            </asp:GridView>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <asp:HyperLink ID="ReturnLink" runat="server" NavigateUrl="~/Activity/ActivitiesList.aspx" Text="<%$ Resources:ShareData, ReturnActivityLink %>" CssClass="btn btn-info">
                </asp:HyperLink>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function VerifiyData() {
            if (Page_ClientValidate("InviteUser") == true) {
                ...
                var param = JSON.stringify({ 'activityId': $("#<%= ActivityIdHiddenField.ClientID %>").val(), 'userId': $("#<%= UserInvitedIdHiddenField.ClientID %>").val() });
                var data;
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ShareActivity.aspx/VerifiyUser",
                    data: param,
                    dataType: "json",
                    async: false,
    ...
    <asp:ObjectDataSource ID="PermissionsObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ActivityIdHiddenField" PropertyName="Value" Name="objectId" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ObjectActionObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        TypeName="Artexacta.App.ObjectAction.BLL.ObjectActionBLL" SelectMethod="GetObjectActionsForActivity"
        OnSelected="ObjectDataSource_Selected">
        <SelectParameters>

<%@ Page Title="Share Activity" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" Runat="Server">
    <div class="row">
        ...
        <div class="col-md-11">
            <h1 class="text-center">
                <asp:Literal ID="TitleLabel" runat="server" Text="Share Activity" />
            </h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <asp:Literal ID="SubtitleLabel" runat="server" Text="You are sharing an Activity: " />
    ...
    <div class="container">
        <div class="tile">
            <div class="t-header">
                <div class="th-title">Users with permissions for this activity:</div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="PermissionsGridView" runat="server" Width="100%" GridLines="None" DataSourceID="PermissionsObjectDataSource"  
                                ...
                                <EmptyDataTemplate>
                                    <p class="text-center">
                                        There are no users with permissions for this Activity
                                    </p>
                                </EmptyDataTemplate>
                            </asp:GridView>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <asp:HyperLink ID="ReturnLink" runat="server" NavigateUrl="~/Activity/ActivitiesList.aspx" Text="Back to Activities list"
